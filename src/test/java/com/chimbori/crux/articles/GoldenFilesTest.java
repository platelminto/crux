...
public class GoldenFilesTest {
  ...
  public void testAOLNews() {
    Article article = TestHelper.extractFromTestFile("http://www.aolnews.com/nation/article/the-few-the-proud-the-marines-getting-a-makeover/19592478", "aolnews.html");
  ...
  @Test
  public void testBBC() {
    Article article = TestHelper.extractFromTestFile("http://www.bbc.co.uk/news/world-latin-america-21226565", "bbc.html");
  ...
  public void testBBC_AMP() {
    Article article = TestHelper.extractFromTestFile("http://www.bbc.co.uk/news/amp/37341871", "bbc-amp.html");
    assertEquals("BBC News", article.siteName);
  ...
  public void testBenjaminStein() {
    Article article = TestHelper.extractFromTestFile("http://benjaminste.in/post/1223476561/hey-guys-whatcha-doing", "benjaminstein.html");
  ...
  public void testBlogger() {
    Article article = TestHelper.extractFromTestFile("http://blog.talawah.net/2011/04/gavin-king-unviels-red-hats-top-secret.html", "blogger.html");
  ...
  public void testBloomberg() {
    Article article = TestHelper.extractFromTestFile("http://www.bloomberg.com/news/2010-11-01/china-becomes-boss-in-peru-on-50-billion-mountain-bought-for-810-million.html", "bloomberg.html");
  ...
  public void testBoingBoing() {
    Article article = TestHelper.extractFromTestFile("http://www.boingboing.net/2010/08/18/dr-laura-criticism-o.html", "boingboing.html");
  ...
  public void testBrOnline() {
    Article article = TestHelper.extractFromTestFile("http://www.br-online.de/br-klassik/programmtipps/highlight-bayreuth-tannhaeuser-festspielzeit-2011-ID1309895438808.xml", "br-online.html");
  ...
  public void testCNet() {
    Article article = TestHelper.extractFromTestFile("http://www.cnet.com/news/verizon-shows-off-ipad-tv-app-and-more/", "cnet.html");
  ...
  public void testCaltonCaldwell() {
    Article article = TestHelper.extractFromTestFile("http://daltoncaldwell.com/dear-mark-zuckerberg", "daltoncaldwell.html");
  ...
  public void testCracked() {
    Article article = TestHelper.extractFromTestFile("http://www.cracked.com/blog/the-9-circles-vacation-hell/", "cracked.html");
  ...
  public void testESPN() {
    Article article = TestHelper.extractFromTestFile("http://www.espn.com/espn/commentary/news/story?id=5461430", "espn.html");
  ...
  public void testESPN2() {
    Article article = TestHelper.extractFromTestFile("http://www.espn.com/golf/pgachampionship10/news/story?id=5463456", "espn2.html");
  ...
  public void testEconomist() {
    Article article = TestHelper.extractFromTestFile("http://www.economist.com/node/17956885", "economist.html");
  ...
  public void testEhow() {
    Article article = TestHelper.extractFromTestFile("http://www.ehow.com/how_5122199_eat-fresh-figs.html", "ehow.html");
  ...
  public void testEngadget() {
    Article article = TestHelper.extractFromTestFile("http://www.engadget.com/2010/08/18/verizon-fios-set-top-boxes-getting-a-new-hd-guide-external-stor/", "engadget.html");
  ...
  public void testEspn3WithFlashVideo() {
    Article article = TestHelper.extractFromTestFile("http://sports.espn.go.com/nfl/news/story?id=5971053", "espn3.html");
  ...
  public void testFolhaUolComBr() {
    Article article = TestHelper.extractFromTestFile("http://m.folha.uol.com.br/ciencia/2017/01/1854055-no-futuro-as-pessoas-nao-morrerao-por-envelhecimento-diz-cientista.shtml?mobile", "folha_uol_com_br.html");
  ...
  public void testFoxNews() {
    Article article = TestHelper.extractFromTestFile("http://www.foxnews.com/politics/2010/08/14/russias-nuclear-help-iran-stirs-questions-improved-relations/", "foxnews.html");
  ...
  public void testFoxSports() {
    Article article = TestHelper.extractFromTestFile("http://msn.foxsports.com/nfl/story/Tom-Cable-fired-contract-option-Oakland-Raiders-coach-010411", "foxsports.html");
  ...
  public void testGaltimeWhereUrlContainsSpaces() {
    Article article = TestHelper.extractFromTestFile("http://galtime.com/article/entertainment/37/22938/kris-humphries-avoids-kim-talk-gma", "galtime.com.html");
  ...
  public void testGigaOm() {
    Article article = TestHelper.extractFromTestFile("http://gigaom.com/apple/apples-next-macbook-an-800-mac-for-the-masses/", "gigaom.html");
  ...
  public void testGizmodo() {
    Article article = TestHelper.extractFromTestFile("http://www.gizmodo.com.au/2010/08/xbox-kinect-gets-its-fight-club/", "gizmodo.html");
  ...
  public void testGolem() {
    Article article = TestHelper.extractFromTestFile("http://www.golem.de/1104/82797.html", "golem.html");
  ...
  public void testGoogleComTablet() {
    Article article = TestHelper.extractFromTestFile("https://www.google.com/", "google_tablet.html");
  ...
  public void testGuardianAmpPage() {
    Article article = TestHelper.extractFromTestFile("https://cdn.ampproject.org/c/s/amp.theguardian.com/business/2016/nov/07/world-stock-markets-surge-clinton-us-election", "guardian-amp.html");
  ...
  public void testHackerNews() {
    Article article = TestHelper.extractFromTestFile("https://news.ycombinator.com/", "hackernews.html");
  ...
  public void testHackerNoon() {
    Article article = TestHelper.extractFromTestFile("https://hackernoon.com/design-thinking-lessons-from-our-cats-9a43fd71457a", "hackernoon.html");
  ...
  public void testHeise() {
    Article article = TestHelper.extractFromTestFile("http://www.heise.de/newsticker/meldung/Internet-Explorer-9-jetzt-mit-schnellster-JavaScript-Engine-1138062.html", "heise.html");
  ...
  public void testHuffingtonPost() {
    Article article = TestHelper.extractFromTestFile("http://www.huffingtonpost.com/2010/08/13/federal-reserve-pursuing_n_681540.html", "huffingtonpost.html");
  ...
  public void testI4Online() {
    Article article = TestHelper.extractFromTestFile("https://i4online.com", "i4online.html");
  ...
  public void testITunes() {
    Article article = TestHelper.extractFromTestFile("http://itunes.apple.com/us/album/21/id420075073", "itunes.html");
  ...
  public void testKhaamaPress() {
    Article article = TestHelper.extractFromTestFile("http://www.khaama.com/over-100-school-girls-poisoned-in-western-afghanistan-0737", "khaama.html");
  ...
  public void testLifehacker() {
    Article article = TestHelper.extractFromTestFile("http://lifehacker.com/5659837/build-a-rocket-stove-to-heat-your-home-with-wood-scraps", "lifehacker.html");
  ...
  public void testMSNBC() {
    Article article = TestHelper.extractFromTestFile("http://www.msnbc.msn.com/id/41207891/ns/world_news-europe/", "msnbc.html");
  ...
  public void testMashable() {
    Article article = TestHelper.extractFromTestFile("http://mashable.com/2010/08/18/how-tonot-to-ask-someone-out-online/", "mashable.html");
  ...
  @Test
  public void testNYT() {
    Article article = TestHelper.extractFromTestFile("http://dealbook.nytimes.com/2011/04/11/for-defense-in-galleon-trial-no-time-to-rest/", "nyt.html");
  ...
  public void testNYT2() {
    Article article = TestHelper.extractFromTestFile("http://www.nytimes.com/2010/12/22/world/europe/22start.html", "nyt2.html");
  ...
  public void testNewYorker() {
    Article article = TestHelper.extractFromTestFile("http://www.newyorker.com/humor/borowitz-report/scientists-earth-endangered-by-new-strain-of-fact-resistant-humans", "newyorker.html");
  ...
  public void testNewsweek() {
    Article article = TestHelper.extractFromTestFile("http://www.newsweek.com/sport-rio-2016-paralympics-euthanasia-497932", "newsweek.html");
  ...
  public void testNinjaTraderBlog() {
    Article article = TestHelper.extractFromTestFile("http://www.ninjatraderblog.com/im/2010/10/seo-marketing-facts-about-google-instant-and-ranking-your-website/", "ninjatraderblog.html");
  ...
  public void testPolitico() {
    Article article = TestHelper.extractFromTestFile("http://www.politico.com/news/stories/1010/43352.html", "politico.html");
  ...
  public void testReadWriteWeb() {
    Article article = TestHelper.extractFromTestFile("http://readwrite.com/2016/09/13/san-francisco-uc-berkeley-keep-smart-transit-city-plan-rolling-cl4/", "readwriteweb.html");
  ...
  public void testRedditAtomFeed() {
    Article article = TestHelper.extractFromTestFile("https://www.reddit.com/r/androidapps/comments/4nle7s/dev_hermit_has_a_new_ad_blocker_50_off_premium/", "reddit.html");
  ...
  public void testRetractionWatch() {
    Article article = TestHelper.extractFromTestFile("http://retractionwatch.com/2017/04/26/troubling-new-way-evade-plagiarism-detection-software-tell-used/", "retraction_watch.html");
  ...
  public void testReuters() {
    Article article = TestHelper.extractFromTestFile("http://www.reuters.com/article/us-knightcapital-trading-technology-idUSBRE87203X20120803", "reuters.html");
  ...
  public void testRian() {
    Article article = TestHelper.extractFromTestFile("http://en.rian.ru/world/20110410/163458489.html", "rian.html");
  ...
  public void testScience() {
    Article article = TestHelper.extractFromTestFile("http://news.sciencemag.org/sciencenow/2011/04/early-birds-smelled-good.html", "sciencemag.html");
  ...
  public void testScientificDaily() {
    Article article = TestHelper.extractFromTestFile("http://www.scientificamerican.com/article.cfm?id=bpa-semen-quality", "scientificamerican.html");
  ...
  public void testSfGate() {
    Article article = TestHelper.extractFromTestFile("http://www.sfgate.com/business/article/Foreclosure-activity-dips-in-California-Bay-Area-3248321.php", "sfgate.html");
  ...
  public void testShockYa() {
    Article article = TestHelper.extractFromTestFile("http://www.shockya.com/news/2011/01/30/daily-shock-jonathan-knight-of-new-kids-on-the-block-publicly-reveals-hes-gay/", "shockya.html");
  ...
  public void testSlamMagazine() {
    Article article = TestHelper.extractFromTestFile("http://www.slamonline.com/online/nba/2010/10/nba-schoolyard-rankings/", "slamonline.html");
  ...
  public void testSpiegel() {
    Article article = TestHelper.extractFromTestFile("http://www.spiegel.de/netzwelt/gadgets/retro-pc-commodore-reaktiviert-den-c64-a-755090.html", "spiegel.html");
  ...
  public void testSportingNews() {
    Article article = TestHelper.extractFromTestFile("http://www.sportingnews.com/nfl/feed/2011-01/nfl-coaches/story/raiders-cut-ties-with-cable", "sportingnews.html");
  ...
  public void testSportsIllustrated() {
    Article article = TestHelper.extractFromTestFile("http://www.si.com/nba/2016/09/07/shaq-basketball-hall-of-fame-lakers-magic-heat-lsu-tigers", "sportsillustrated.html");
  ...
  public void testStackOverflow() {
    Article article = TestHelper.extractFromTestFile("http://stackoverflow.com/questions/3553693/wicket-vs-vaadin/3660938", "stackoverflow.html");
  ...
  public void testTazBlog() {
    Article article = TestHelper.extractFromTestFile("http://www.taz.de/1/politik/asien/artikel/1/anti-atomkraft-nein-danke/", "taz.html");
  ...
  public void testTechCrunch() {
    Article article = TestHelper.extractFromTestFile("http://techcrunch.com/2011/04/04/twitter-advanced-search/", "techcrunch.html");
  ...
  public void testTechCrunch2() {
    Article article = TestHelper.extractFromTestFile("http://techcrunch.com/2010/08/13/gantto-takes-on-microsoft-project-with-web-based-project-management-application/", "techcrunch2.html");
  ...
  public void testTheAtlantic() {
    Article article = TestHelper.extractFromTestFile("http://www.theatlantic.com/business/archive/2016/09/census-poverty-economy-terrible/499793/", "theatlantic.html");
  ...
  public void testTheDailyBeast() {
    Article article = TestHelper.extractFromTestFile("http://www.thedailybeast.com/blogs-and-stories/2010-11-01/ted-sorensen-speechwriter-behind-jfks-best-jokes/?cid=topic:featured1", "thedailybeast.html");
  ...
  public void testTheFrisky() {
    Article article = TestHelper.extractFromTestFile("http://www.thefrisky.com/2010-10-28/rachel-dratch-met-her-baby-daddy-in-a-bar/", "thefrisky.html");
  ...
  public void testTheVacationGals() {
    Article article = TestHelper.extractFromTestFile("http://thevacationgals.com/vacation-rental-homes-are-a-family-reunion-necessity/", "thevacationgals.html");
  ...
  public void testTraindom() {
    Article article = TestHelper.extractFromTestFile("http://blog.traindom.com/places-where-to-submit-your-startup-for-coverage/", "traindom.html");
  ...
  public void testTwitpic() {
    Article article = TestHelper.extractFromTestFile("http://twitpic.com/4k1ku3", "twitpic.html");
  ...
  public void testTwitpic2() {
    Article article = TestHelper.extractFromTestFile("http://twitpic.com/4kuem8", "twitpic2.html");
  ...
  public void testTwitterBlog() {
    Article article = TestHelper.extractFromTestFile("http://engineering.twitter.com/2011/04/twitter-search-is-now-3x-faster_1656.html", "twitter.html");
  ...
  public void testUniverseToday() {
    Article article = TestHelper.extractFromTestFile("http://www.universetoday.com/76881/podcast-more-from-tony-colaprete-on-lcross/", "universetoday.html");
  ...
  public void testUsaToday2() {
    Article article = TestHelper.extractFromTestFile("http://content.usatoday.com/communities/driveon/post/2010/08/gm-finally-files-for-ipo/1", "usatoday2.html");
  ...
  public void testUsatoday() {
    Article article = TestHelper.extractFromTestFile("http://content.usatoday.com/communities/thehuddle/post/2010/08/brett-favre-practices-set-to-speak-about-return-to-minnesota-vikings/1", "usatoday.html");
  ...
  public void testVentureBeat() {
    Article article = TestHelper.extractFromTestFile("http://social.venturebeat.com/2010/08/18/facebook-reveals-the-details-behind-places/", "venturebeat.html");
  ...
  public void testWallStreetJournal() {
    Article article = TestHelper.extractFromTestFile("http://www.wsj.com/articles/SB10001424052748704532204575397061414483040", "wsj.html");
  ...
  public void testWashingtonPost() {
    Article article = TestHelper.extractFromTestFile("https://www.washingtonpost.com/lifestyle/style/the-nearly-forgotten-story-of-the-black-women-who-helped-land-a-man-on-the-moon/2016/09/12/95f2d356-7504-11e6-8149-b8d05321db62_story.html", "washingtonpost.html");
  ...
  public void testWikipedia() {
    Article article = TestHelper.extractFromTestFile("http://en.wikipedia.org/wiki/Therapsids", "wikipedia.html");
  ...
  public void testWikipediaDarwin() {
    Article article = TestHelper.extractFromTestFile("https://en.wikipedia.org/wiki/Charles_Darwin", "wikipedia_darwin.html");
  ...
  public void testWikipediaGalileo() {
    Article article = TestHelper.extractFromTestFile("https://en.wikipedia.org/wiki/Galileo_Galilei", "wikipedia_galileo.html");
  ...
  public void testWikipediaOktoberfest() {
    Article article = TestHelper.extractFromTestFile("https://de.m.wikipedia.org/wiki/Oktoberfest", "wikipedia_oktoberfest.html");
  ...
  public void testWired() {
    Article article = TestHelper.extractFromTestFile("http://www.wired.com/playbook/2010/08/stress-hormones-boxing/", "wired.html");
  ...
  public void testWordpress() {
    Article article = TestHelper.extractFromTestFile("http://karussell.wordpress.com/", "wordpress.html");
  ...
  public void testYCombinator() {
    Article article = TestHelper.extractFromTestFile("http://paulgraham.com/seesv.html", "ycombinator.html");
  ...
  public void testYomiuri() {
    Article article = TestHelper.extractFromTestFile("http://www.yomiuri.co.jp/e-japan/gifu/news/20110410-OYT8T00124.htm", "yomiuri.html");
  ...
  public void testYouTube() {
    Article article = TestHelper.extractFromTestFile("https://www.youtube.com/watch?v=wlupmjrfaB4", "youtube.html");
